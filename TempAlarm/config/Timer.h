...
#define TempAlarm_Timer_Configuration_h
	 ...
	 */
		...
		#define TIMER_BUTTON_STARTSTOP_THRESHOLD 50
		#define TIMER_BUTTON_STARTSTOP_DELAY 50
		...
		#define TIMER_BUTTON_CONTROL_SWITCH_THRESHOLD 50
		#define TIMER_BUTTON_CONTROL_SWITCH_DELAY 50
