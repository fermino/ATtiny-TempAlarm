...
#define TempAlarm_Timer_Configuration_h
	 ...
	 */
		...
		#define TIMER_BUTTON_ADD_HOUR_ID 4
		#define TIMER_BUTTON_ADD_MINUTE_ID 5
		#define TIMER_BUTTON_ADD_SECOND_ID 6
		#define TIMER_BUTTON_ADD_THRESHOLD 50

		#define TIMER_BUTTON_STARTSTOP_ID 7
		#define TIMER_BUTTON_STARTSTOP_THRESHOLD 100
		#define TIMER_BUTTON_STARTSTOP_DELAY 100

		#define TIMER_BUTTON_CONTROL_ID 8
		#define TIMER_BUTTON_CONTROL_RESET_THRESHOLD 500
		#define TIMER_BUTTON_CONTROL_RESET_DELAY 500
		#define TIMER_BUTTON_CONTROL_SWITCH_THRESHOLD 100
		#define TIMER_BUTTON_CONTROL_SWITCH_DELAY 100
